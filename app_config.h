...
#define APP_PWM_MAX_PERMILLE           (100)
...
#define APP_BATTERY_LOW_MV             (8000UL)
...
#define APP_DIAG_PWM_PERMILLE          (100)
#define APP_AUTO_BASE_PWM_PERMILLE     (100)
...
#define APP_AUTO_TARGET_SPEED_MM_S     (80)
