...
ARGUMENTS: 你来帮我烧录上述代码

## 助手

没有 ARM-GCC 工具链也没有 Keil CLI 编译器，无法从命令行编译。

**你得先在 Keil 里编译，然后我帮你烧录。**

### 你在 Keil 里做的：

1. 打开项目 `D:\TI\mspm0_sdk_2_02_00_05\20948\keil\empty_LP_MSPM0G3507_nortos_keil.uvprojx`
2. 移除 `empty.c`，添加这 4 个文件：
   - `i2c_msp.c`
   - `icm20948.c`
   - `ssd1306.c`
   - `main.c`
...
编译成功后告诉我，我立刻用 CMSIS-DAP 把生成的 `.axf` 烧进去——探针已经识别到了：

```
CMSIS-DAP_LU (C251:F001) LU_2022_8888  ← 已连接，就等你的固件
```
...
<command-args>D:\TI\mspm0_sdk_2_02_00_05\20948\keil这个工作目标啊</command-args>
